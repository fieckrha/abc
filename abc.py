...
helpMessage =""" BOT Menu  􀔃􀄆red check mark􏿿
...
[@Up]       Fungsi Spam Chat
[Tagall,kiwkiw]   Mention Semua User
...
[Welcome] stiker welcome
[#Welcome] ucapan untuk member baru
[Bc ] broadcast tulisan
[ZSIsay (hi,pagi,)
[@Ping] pong
[Gift]
...
Bots=[mid,Amid,Bmid,Cmid,'u349dbde6509797ddc33adce5b85cd856','udf271394eea3e117351be4e30654140c','u16bc85075e502b66e4b715069bc05cb1','ud0c9863689311b0da0c8566f4401281d','uc103c714511b0b65dc30315ec9c58f95','u97f705b63d3da6099072d4ccf6a299e2']
...
wait = {
    ...
    "cName10":"ZSI10 ",
    "blacklist":{},
    "badboyz":{"u349dbde6509797ddc33adce5b85cd856"},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
    "Protectjoin":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
            ...
            elif ("ZSI1 gn " in msg.text):
              if msg.from_ in Bots:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("ZSI1 gn ","")
                    ki.updateGroup(X)
                else:
              ...
              if msg.from_ in Bots:
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","ZSI1 gift"]:
              if msg.from_ in Bots:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","ZSI2 gift"]:
              if msg.from_ in Bots:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                ...
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","ZSI3 gift"]:
              if msg.from_ in Bots:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
              ...
              if msg.from_ in Bots:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["ZSI1 ourl","ZSI1 link on"]:
              if msg.from_ in Bots:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
              ...
              if msg.from_ in Bots:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["ZSI1 curl","ZSI1 link off"]:
              if msg.from_ in Bots:
                if msg.toType == 2:
...
#			cl.sendText(msg.to,"Sukses join ke grup %s" % str(group.name))
              ...
              if msg.from_ in Bots:
                ...
                msg.contentMetadata = {
                                     ...
                                     "STKVER": "100" }
                cl.sendMessage(msg)
            elif msg.text in ["Hehehe","Hehe","He","hehehe","hehe","he","Haha"]:
              if msg.from_ in Bots:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
            ...
            elif msg.text in ["ZSI1 rename "]:
              if msg.from_ in Bots:
                string = msg.text.replace("ZSI1 rename ","")
                if len(string.decode('utf-8')) <= 20:
              ...
              if msg.from_ in Bots:
                string = msg.text.replace("ZSI2 rename ","")
                if len(string.decode('utf-8')) <= 20:
